...
exports.run = async (bot, msg, args) => {
        ...
        userinfo.dctarih = moment.utc(msg.guild.members.cache.get(user.id).user.createdAt).format('**YYYY**  MMMM  dddd  (**DD/MM/YYYY**)')
        ...
        userinfo.dctarihkatilma = moment.utc(msg.guild.members.cache.get(user.id).joinedAt).format('**YYYY**  MMMM  dddd  (**DD/MM/YYYY**)')
        ...
        .setColor('GREEN')
        .addField(`Sunucuya Katılma Tarihi :`, userinfo.dctarihkatilma, false)
        .addField(`Discorda Katılma Tarihi :`, userinfo.dctarih, false)
    ...
    exports.conf = {
        name: "kullanıcı",
        aliases: ["kullanıcıbilgi","kullanicibilgi","kb","uinfo"],
        permLevel: 0
    };